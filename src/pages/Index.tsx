  ...
  const services = [
    {
      ...
      description: "Estratégias personalizadas para otimizar suas chamadas de vendas e atendimento ao cliente."
    },
    {
      icon: BookOpen,
      title: "Concepção de Ebooks",
      description: "Criação de ebooks profissionais para gerar leads e autoridade no seu mercado."
    },
    {
      icon: ShoppingBag,
      title: "Vendas sem Rosto",
      description: "Alternativas inteligentes para vender em marketplaces e redes sociais sem precisar mostrar seu rosto."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8">
              <a href="#servicos" className="text-blue-700 hover:text-blue-900 transition-colors">Serviços</a>
              <a href="#contato" className="text-blue-700 hover:text-blue-900 transition-colors">Contato</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-700 mb-8 max-w-2xl mx-auto">
            ...
            Especialistas em estratégias de vendas e consultoria empresarial.
          </p>
      ...
      <section id="servicos" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-blue-900 mb-4">Nossos Serviços</h3>
      ...
      <section id="contato" className="py-20 px-4 bg-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-4xl font-bold text-blue-900 mb-4">Vamos Conversar?</h3>
          <p className="text-xl text-blue-700 mb-12 max-w-2xl mx-auto">
            Estamos prontos para entender suas necessidades e apresentar as melhores soluções para seu negócio.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-md mx-auto">
            {contactMethods.map((method, index) => (
              <Button 
                key={index}
                size="lg"
                className="bg-white hover:bg-blue-50 text-blue-900 border border-blue-200 px-6 py-4 text-left justify-start"
      ...
      <footer className="bg-blue-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-blue-200">Especialistas em estratégias digitais</p>
          </div>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button 
              variant="ghost" 
              className="text-white hover:text-blue-200 border border-white/20"
              onClick={() => window.open("https://wa.me/5593984137433", "_blank")}
            >
              <Phone className="mr-2 h-5 w-5" />
              WhatsApp
